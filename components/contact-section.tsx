...
export function ContactSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const whatsappMessage = `Hola! Me contacto desde la web.%0A%0ANombre: ${formData.name}%0AEmail: ${formData.email}%0ATeléfono: ${formData.phone}%0AMensaje: ${formData.message}`
            ...
            <Card className="bg-card/50 backdrop-blur-sm border-border/50">
              <CardContent className="p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">contacto@wortec.com</p>
