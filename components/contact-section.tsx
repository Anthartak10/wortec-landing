...
export function ContactSection() {
  ...
  const canUseWhatsApp = useMemo(() => {
    ...
    return typeof url === "string" && url.includes("wa.me")
  }, [])
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
                ...
                {status === "error" && (
                  <div className="flex items-start gap-3 rounded-lg border border-destructive/30 bg-destructive/10 p-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Intenta de nuevo o escríbenos por correo.</p>
                    </div>
                  </div>
                )}
          ...
          <div className="space-y-6">
            <Card className="bg-card/50 backdrop-blur-sm border-border/50">
              <CardContent className="p-6 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Pendiente (pronto)</p>
            ...
            {/* WhatsApp CTA (solo si existe NEXT_PUBLIC_WHATSAPP_URL) */}
            {canUseWhatsApp && (
